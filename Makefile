...
install:
	@GO111MODULE=on go get github.com/i-DRC/protoc-gen-jsonschema/cmd/protoc-gen-jsonschema && go install github.com/i-DRC/protoc-gen-jsonschema/cmd/protoc-gen-jsonschema
